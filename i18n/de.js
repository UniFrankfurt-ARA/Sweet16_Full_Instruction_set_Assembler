...
(function(global) {
  global.I18N_DE = {
    app: { title: "SWEET16 Prozessorsimulator — Vollständiger Befehlssatz" },
    tab: {
    ...
    card: { userMemory: "Datenspeicher", stack: "Stapel" },
    stack: { empty: "(leer)" },
    instr: {
      syntax: "Syntax",
    ...
    msg: {
      ...
      programFinished: "Programm beendet ({reason}). Speicher erhalten — der erste „Nächster Schritt“ setzt nur PC auf den Anfang (kein Befehl); der nächste Ausführen startet.",
      programFinishedAfterRun: "Alles ausführen beendet. PC steht hinter dem Ende — Speicher lesen. „Nächster Schritt“ = nur PC auf Anfang ohne Befehlsausführung.",
      rewindPcNoExecute: "PC auf Anfang zurück — kein Befehl ausgeführt (Speicher unverändert). Nächster Schritt = erster Befehl.",
    ...
    samplePrograms: {
      ...
      p4: "Indirekter Speicher (STO [Rs], Rt / LDD Rd, [Rs])",
    ...
    instrDesc: {
      ...
      ROL: "Linksrotation über Carry: Rd = (Rs[14:0], CF); MSB von Rs → CF.",
      ROR: "Rechtsrotation über Carry: Rd = (CF, Rs[15:1]); LSB von Rs → CF.",
      ...
      STO: "In Benutzerspeicher: STO [Rs], Rt → Mem[Rs] = Rt.",
      LDD: "Aus Benutzerspeicher: LDD Rd, [Rs] → Rd = Mem[Rs].",
